...
SERVICE_ACCOUNT_EMAIL_ADDRESS = ' qronus@qronus-245107.iam.gserviceaccount.com' # CHANGEME
SERVICE_ACCOUNT_FILE = 'qronus-0da95da0f40e.json' # CHANGEME. Path to file with private key and Google credential config

# Identifier of Google Pay API for Passes Merchant Center
ISSUER_ID = '3293346916822849083'# CHANGEME
